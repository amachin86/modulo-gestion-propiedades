...
## 8. Additional Entity Services
- [ ] Create Properties service folder and move existing logic
- [ ] Create Hosts service folder with CRUD operations
- [ ] Create Users service folder with CRUD operations
- [ ] Create Bookings service folder with CRUD operations
- [ ] Create DomainEvents service folder with CRUD operations
- [ ] Create controllers for Hosts, Users, Bookings, DomainEvents
- [ ] Update DI registrations for new services
